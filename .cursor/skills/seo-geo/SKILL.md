...
> box. The _experience_ is one flow, but the two citation engines remain
...
- **Preferred Sources**, users pick sites that get a "preferred" badge in AI answers; all-languages since 2026-04-30 (>345K sources selected); Google is working toward using it as a ranking signal. _Quick win:_ encourage your audience to add the brand as a Preferred Source.
